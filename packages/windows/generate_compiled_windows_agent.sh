...
help() {
    ...
    echo
    echo "    -b, --branch <branch>     [Optional] Select Git branch to compile Blackwell code."
    echo "    --sources <path>          [Optional] Absolute path containing blackwell source code. This option will use local source code instead of downloading it from GitHub. By default: '../../src'."
