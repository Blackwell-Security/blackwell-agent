...
from api.validator import (check_exp, check_xml, _alphanumeric_param, _array_numbers, _array_names, _boolean, _dates,
                           _empty_boolean, _hashes, _ips, _names, _numbers, _blackwell_key, _paths, _query_param, _ranges,
                           _search_param, _sort_param, _timeframe_type, _type_format, _yes_no_boolean,
                           _get_dirnames_path, allowed_fields, is_safe_path, _blackwell_version,
...
from blackwell import BlackwellError
...
@pytest.mark.parametrize('exp, regex_name', [
    ...
    ('449e3b6ffd9b484c5c645321edd4d610', _blackwell_key),
    # date
    ...
    # version
    ('v4.4.0', _blackwell_version),
    ('4.4.0', _blackwell_version),
    ('blackwell 4.4.0', _blackwell_version),
    ('blackwell v4.4.0', _blackwell_version),
    # miscellaneous
...
@pytest.mark.parametrize('exp, regex_name', [
    ...
    ('449e3b6ffd9b484c5c645321edd4d61$', _blackwell_key),
    # date
    ...
    # version
    ('v4.4', _blackwell_version),
    ('4.4', _blackwell_version),
    ('blackwell 4.4', _blackwell_version),
    ('blackwell v4.4', _blackwell_version),
    # miscellaneous
    ('aDhjasdh3=', _base64),
])
...
def test_is_safe_path():
    ...
    assert not is_safe_path('etc/lists/../../../../../../var/ossec/api/scripts/blackwell_apid.py', relative=True)
...
@pytest.mark.parametrize("component, configuration, expected_response", [
    ("agent", "client", None),
    ("agent", "wmodules", BlackwellError(1128))
])
def test_check_component_configuration_pair(component, configuration, expected_response):
    ...
    not belong to a Blackwell component."""
