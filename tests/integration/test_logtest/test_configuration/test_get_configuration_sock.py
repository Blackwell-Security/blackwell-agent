...
import pytest
from blackwell_testing.constants.paths.sockets import ANALYSISD_ANALISIS_SOCKET_PATH
...
def test_get_configuration_sock(test_configuration, test_metadata, set_blackwell_configuration,
    ...
    description: Check analysis Unix socket returns the correct Logtest configuration under different sets of
                 configurations, `blackwell-analisysd` returns the right information from the `rule_test` configuration
                 ...
                 that the loaded fields from the 'blackwell_conf.yaml' file.
