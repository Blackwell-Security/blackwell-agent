...
from blackwell_testing.constants.paths.configurations import CUSTOM_DECODERS_FILE, CUSTOM_RULES_FILE
...
def setup_local_rules(test_metadata):
    if 'local_rules' in test_metadata:
        ...
        shutil.chown(CUSTOM_RULES_FILE, "blackwell", "blackwell")
...
def setup_local_decoders(test_metadata):
    if 'local_decoders' in test_metadata:
        ...
        shutil.chown(CUSTOM_DECODERS_FILE, "blackwell", "blackwell")
