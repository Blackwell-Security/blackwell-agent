...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/ruleset/cdb-list.html
...
def test_cdb_list(test_configuration, test_metadata, set_blackwell_configuration,
