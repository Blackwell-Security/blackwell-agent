...
from blackwell_testing.modules.remoted.patterns import CONFIGURATION_ERROR, INVALID_VALUE_FOR_ELEMENT
...
def test_invalid_connection(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
    ...
    '''
    description: Check if `blackwell-remoted` fails using invalid 'connection' values and shows the expected error message
