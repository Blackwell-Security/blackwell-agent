...
from blackwell_testing.utils.network import format_ipv6_long, TCP, UDP
from blackwell_testing.utils.sockets import send_message_to_syslog_socket
...
def test_denied_ips_syslog(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
    ...
    '''
    description: Check that 'blackwell-remoted' denied connection to the specified 'denied-ips'.
