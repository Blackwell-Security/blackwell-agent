...
from blackwell_testing.modules.remoted.patterns import INVALID_VALUE_FOR_PORT_NUMBER, CONFIGURATION_ERROR
...
def test_invalid_connection_port(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
    ...
    '''
    description: Check if 'blackwell-remoted' fails using invalid 'port' values and shows the expected error message
