...
from blackwell_testing.tools.simulators.agent_simulator import send_ping_pong_messages
...
def test_ping_pong_message(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_blackwell_configuration, restart_blackwell_expect_error, protocols_list_to_str_upper_case):

    '''
    description: Check if 'blackwell-remoted' sends the #pong message
