...
from blackwell_testing.constants.paths.configurations import SHARED_CONFIGURATIONS_PATH
from blackwell_testing.constants.paths.variables import VAR_MULTIGROUPS_PATH
...
def test_merged_mg_file_content(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_blackwell_configuration, daemons_handler, prepare_environment):

    '''
    description: Check the content of the merged.mg file that blackwell-remoted compiles for multi-groups.
