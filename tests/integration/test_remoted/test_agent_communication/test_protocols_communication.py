...
from blackwell_testing.modules.analysisd.patterns import ANALYSISD_STARTED
from blackwell_testing.tools.mitm import ManInTheMiddle
...
def test_protocols_communication(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_blackwell_configuration, daemons_handler, simulate_agents, configure_sockets_environment_module,
