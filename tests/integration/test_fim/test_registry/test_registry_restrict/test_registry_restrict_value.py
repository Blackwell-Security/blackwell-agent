...
from blackwell_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_MODIFIED, EVENT_TYPE_DELETED
from blackwell_testing.modules.agentd.configuration import AGENTD_WINDOWS_DEBUG
from blackwell_testing.modules.fim.utils import get_fim_event_data, delete_registry, delete_registry_value, create_registry_value
...
def test_restrict_value(test_configuration, test_metadata,configure_local_internal_options,
                            truncate_monitored_files, set_blackwell_configuration, create_registry_key, daemons_handler, detect_end_scan):
    '''
    ...
    if test_metadata['triggers_event']:
        blackwell_log_monitor.start(callback=generate_callback(EVENT_TYPE_MODIFIED))
