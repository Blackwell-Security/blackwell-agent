...
brief: File Integrity Monitoring (FIM) system watches selected files and triggering alerts when
       ...
       the 'blackwell-syscheckd' daemon set in the 'process_priority' tag is applied successfully.
       The FIM capability is managed by the 'blackwell-syscheckd' daemon, which checks
...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/reference/ossec-conf/syscheck.html#process-priority
...
from blackwell_testing.modules.agentd.configuration import AGENTD_DEBUG
...
from blackwell_testing.constants.daemons import SYSCHECK_DAEMON
...
def test_process_priority(test_configuration, test_metadata, configure_local_internal_options,
    ...
    '''
    description: Check if the process priority of the 'blackwell-syscheckd' daemon set in the 'process_priority' tag
                 ...
                 the 'blackwell-syscheckd' process. Finally, the test will compare the current process priority
    ...
    assertions:
        - Verify that the 'blackwell-syscheckd' daemon is running.
        - Verify that the process priority of the 'blackwell-syscheckd' daemon matches the 'process_priority' tag.

    input_description: A test case (ossec_conf) is contained in external YAML file (cases_process_priority.yaml)
                       which includes configuration settings for the 'blackwell-syscheckd' daemon and,
