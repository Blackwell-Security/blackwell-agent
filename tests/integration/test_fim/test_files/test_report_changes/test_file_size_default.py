...
from blackwell_testing.modules.fim.patterns import FILE_SIZE_LIMIT_REACHED, EVENT_TYPE_REPORT_CHANGES, ERROR_MSG_REPORT_CHANGES_EVENT_NOT_DETECTED, \
...
def test_file_size_default(test_configuration, test_metadata, configure_local_internal_options,
    ...
    assert 'More changes...' in str(blackwell_log_monitor.callback_result), 'Wrong content_changes field'
