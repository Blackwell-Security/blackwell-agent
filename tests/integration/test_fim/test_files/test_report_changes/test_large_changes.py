...
from blackwell_testing.utils.file import truncate_file, write_file_write
...
def test_large_changes(test_configuration, test_metadata, configure_local_internal_options,
                        truncate_monitored_files, set_blackwell_configuration, folder_to_monitor, daemons_handler, detect_end_scan):
    '''
    description: Check if the 'blackwell-syscheckd' daemon detects the character limit in the file changes is reached
