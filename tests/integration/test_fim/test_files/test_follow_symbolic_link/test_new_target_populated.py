...
from blackwell_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_MODIFIED, LINKS_SCAN_FINALIZED
...
def test_new_target_populated(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
