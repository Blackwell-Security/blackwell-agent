...
from blackwell_testing.modules.fim.patterns import EVENT_TYPE_ADDED, WIN_CONVERT_FOLDER
...
def test_windows_system_monitoring(test_configuration, test_metadata, configure_local_internal_options,
    ...
    '''
    description: Check if the 'blackwell-syscheckd' monitors the windows system folders (System32 and SysWOW64) properly,
    ...
    if test_metadata['redirected']:
        blackwell_log_monitor.start(callback=generate_callback(WIN_CONVERT_FOLDER))
