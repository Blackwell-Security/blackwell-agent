...
def test_ignore_works_over_restrict(test_configuration, test_metadata, set_blackwell_configuration, configure_local_internal_options,
    ...
    blackwell_log_monitor.start(callback=generate_callback(test_metadata['regex']))
