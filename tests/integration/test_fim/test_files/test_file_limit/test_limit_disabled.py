...
from blackwell_testing.modules.fim.patterns import FILE_LIMIT_DISABLED
...
def test_limit_disabled(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
                        configure_local_internal_options, folder_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'blackwell-syscheckd' daemon detects that the 'file_limit' feature of FIM is disabled.
    ...
    blackwell_log_monitor.start(generate_callback(FILE_LIMIT_DISABLED))
