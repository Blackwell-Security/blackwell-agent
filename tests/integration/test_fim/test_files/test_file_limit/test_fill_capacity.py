...
from blackwell_testing.modules.fim.patterns import FILE_LIMIT_PERCENTAGE, INODE_ENTRIES_PATH_COUNT, FILE_LIMIT_AMOUNT, FILE_ENTRIES_PATH_COUNT
...
def test_fill_capacity(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
                       configure_local_internal_options, folder_to_monitor, fill_folder_to_monitor,
                       daemons_handler, start_monitoring):
    '''
    description: Check if the 'blackwell-syscheckd' daemon generates events for different capacity thresholds limits.
