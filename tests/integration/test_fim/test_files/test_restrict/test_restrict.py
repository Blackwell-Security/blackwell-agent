...
from blackwell_testing.modules.fim.patterns import EVENT_TYPE_ADDED, FIM_EVENT_RESTRICT
...
def test_restrict(test_configuration, test_metadata, set_blackwell_configuration, configure_local_internal_options,
                  truncate_monitored_files, folder_to_monitor, daemons_handler, file_to_monitor):
    '''
    description: Check if the 'blackwell-syscheckd' daemon detects or ignores events in monitored files depending
    ...
    input_description: Different test cases are contained in external YAML file (blackwell_conf.yaml) which
