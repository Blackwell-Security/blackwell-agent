...
brief: These tests will check if the 'blackwell-syscheckd' and 'auditd' daemons work together properly.
...
from blackwell_testing.modules.fim.patterns import WHODATA_NOT_STARTED
...
def test_remove_audit(test_configuration, test_metadata, set_blackwell_configuration, configure_local_internal_options,
    ...
    test_phases:
        - setup:
            ...
            - Restart blackwell to apply configuration changes.
        - test:
    ...
    input_description: A test case is contained in external YAML file (configuration_remove_audit.yaml)
                       which includes configuration settings for the 'blackwell-syscheckd' daemon
