...
from blackwell_testing.modules.fim.patterns import EVENT_TYPE_DELETED, INODE_ENTRIES_PATH_COUNT
...
def test_delete_multiple_files(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
    ...
    # Assert
    blackwell_log_monitor.start(generate_callback(INODE_ENTRIES_PATH_COUNT))
    inode_entries, path_count = blackwell_log_monitor.callback_result
