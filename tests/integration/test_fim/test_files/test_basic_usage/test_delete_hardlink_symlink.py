...
from blackwell_testing.modules.fim.patterns import INODE_ENTRIES_PATH_COUNT
...
def test_delete_hardlink_symlink(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
