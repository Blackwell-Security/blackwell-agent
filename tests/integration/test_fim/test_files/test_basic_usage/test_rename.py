...
def test_rename(test_configuration, test_metadata, set_blackwell_configuration, configure_local_internal_options,
                truncate_monitored_files, folder_to_monitor, daemons_handler, start_monitoring, path_to_edit):
    '''
    description: Check if the 'blackwell-syscheckd' daemon detects 'added' and 'deleted' events when renaming a
    ...
    input_description: The test cases are contained in external YAML file (cases_rename.yaml) which includes
                       configuration parameters for the 'blackwell-syscheckd' daemon and testing directories
