...
def test_bucket_and_service_missing(
        test_configuration, metadata, load_blackwell_basic_configuration, set_blackwell_configuration,
        configure_local_internal_options_function, truncate_monitored_files, restart_blackwell_function_without_exception,
        file_monitoring
):
    """
    ...
    parameters:
        ...
        - restart_blackwell_function_without_exception:
            type: fixture
            brief: Restart the blackwell service catching the exception.
        - file_monitoring:
            type: fixture
