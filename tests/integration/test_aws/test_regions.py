...
from blackwell_testing.constants.aws import RANDOM_ACCOUNT_ID
from blackwell_testing.constants.paths.aws import AWS_SERVICES_DB_PATH, S3_CLOUDTRAIL_DB_PATH
from blackwell_testing.modules.aws.utils import path_exist
from blackwell_testing.utils.db_queries.aws_db import (get_multiple_service_db_row, table_exists_or_has_values,
...
def test_cloudwatch_regions(
        test_configuration, metadata, load_blackwell_basic_configuration, create_test_log_group, create_test_log_stream,
        manage_log_group_events, set_blackwell_configuration, clean_aws_services_db,
...
def test_inspector_regions(
        test_configuration, metadata, load_blackwell_basic_configuration,
        set_blackwell_configuration, clean_aws_services_db, configure_local_internal_options_function,
        truncate_monitored_files, restart_blackwell_function, file_monitoring
):
    """
    description: Only the logs for the specified region are processed.
