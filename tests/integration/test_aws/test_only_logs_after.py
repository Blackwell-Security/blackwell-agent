...
from blackwell_testing.constants.paths.aws import S3_CLOUDTRAIL_DB_PATH, AWS_SERVICES_DB_PATH
from blackwell_testing.constants.aws import ONLY_LOGS_AFTER_PARAM, VPC_FLOW_TYPE, US_EAST_1_REGION
from blackwell_testing.utils.db_queries.aws_db import get_multiple_s3_db_row, get_service_db_row, get_s3_db_row
from blackwell_testing.modules.aws.utils import (call_aws_module, upload_log_events, create_log_stream, path_exist,
                                             get_last_file_key, analyze_command_output,
                                             generate_file, upload_bucket_file)
from blackwell_testing.modules.aws.patterns import (NO_LOG_PROCESSED, NO_BUCKET_LOG_PROCESSED, MARKER, NO_NEW_EVENTS,
                                                EVENT_SENT)
...
def test_bucket_without_only_logs_after(
        ...
        load_blackwell_basic_configuration, set_blackwell_configuration, clean_s3_cloudtrail_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_blackwell_function,
        file_monitoring
):
    """
...
def test_service_without_only_logs_after(
        ...
        load_blackwell_basic_configuration, set_blackwell_configuration, clean_aws_services_db,
        configure_local_internal_options_function, truncate_monitored_files, restart_blackwell_function, file_monitoring
):
    """
...
def test_bucket_multiple_calls(
        ...
        load_blackwell_basic_configuration, restart_blackwell_function
):
    """
...
def test_inspector_multiple_calls(
    metadata, clean_aws_services_db, load_blackwell_basic_configuration, restart_blackwell_function
):
    """
    description: Call the AWS module multiple times with different only_logs_after values.
    test_phases:
...
def test_cloudwatch_multiple_calls(
        ...
        logs_clients, load_blackwell_basic_configuration, restart_blackwell_function
):
    """
    description: Call the AWS module multiple times with different only_logs_after values.
    test_phases:
