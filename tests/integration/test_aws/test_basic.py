...
def test_bucket_defaults(
        test_configuration, metadata, create_test_bucket, load_blackwell_basic_configuration, set_blackwell_configuration,
        clean_s3_cloudtrail_db, configure_local_internal_options_function, truncate_monitored_files,
        restart_blackwell_function, file_monitoring
):
    """
...
def test_service_defaults(
        test_configuration, metadata, create_test_log_group, load_blackwell_basic_configuration,
