...
from blackwell_testing.constants.paths.configurations import BLACKWELL_CLIENT_KEYS_PATH, DEFAULT_AUTHD_PASS_PATH
from blackwell_testing.tools.simulators.authd_simulator import AuthdSimulator
from blackwell_testing.utils.file import write_file, remove_file
...
def set_keys(test_metadata):
    ...
    for key in test_metadata.get('pre_existent_keys', []):
        write_file(BLACKWELL_CLIENT_KEYS_PATH, key)
