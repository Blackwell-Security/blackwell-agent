...
brief: These tests will check if the 'rbac_mode' (Role-Based Access Control) setting of the API
       ...
       'whitelist mode' and 'blacklist mode'. The Blackwell API is an open source 'RESTful' API
       that allows for interaction with the Blackwell manager from a web browser, command line tool
...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/api/configuration.html#rbac-mode
...
from blackwell_testing.constants.api import CONFIGURATION_TYPES, MANAGER_INFORMATION_ROUTE
