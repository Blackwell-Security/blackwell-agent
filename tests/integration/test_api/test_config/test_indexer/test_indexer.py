...
def test_indexer(test_configuration, test_metadata, set_blackwell_configuration, add_configuration,
    ...
    if not test_metadata['expected_indexer_enabled']:
        enabled = 'no'
    assert f"<enabled>{enabled}</enabled>" in blackwell_config
