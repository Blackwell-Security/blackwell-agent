...
brief: These tests will check if the IP blocking feature of the API handled by the 'blackwell-apid' daemon
       is working properly. The Blackwell API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/api/configuration.html#access
...
from blackwell_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
from blackwell_testing.modules.api.utils import login
