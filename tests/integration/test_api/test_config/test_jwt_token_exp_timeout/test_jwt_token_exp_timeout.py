...
brief: These tests will check if the 'auth_token_exp_timeout' setting of the API is working properly.
       ...
       The Blackwell API is an open source 'RESTful' API that allows for interaction with the Blackwell manager
...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/api/configuration.html#auth-token-exp-timeout
