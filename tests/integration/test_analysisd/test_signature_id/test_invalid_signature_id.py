...
from blackwell_testing.modules.analysisd.testrule import patterns
...
def test_invalid_signature_id(test_configuration, test_metadata, set_blackwell_configuration, truncate_monitored_files,
    ...
    assertions:
        - Check that blackwell starts
        - Check ".*blackwell-testrule.*Empty 'if_sid' value. Rule '(\\d*)' will be ignored.*"
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(BLACKWELL_LOG_PATH)
