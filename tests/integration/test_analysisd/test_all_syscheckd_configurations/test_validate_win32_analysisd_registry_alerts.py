...
brief: The 'blackwell-analysisd' daemon receives the log messages and compares them to the rules.
       ...
       Specifically, these tests will verify if the 'blackwell-analysisd' daemon generates valid
...
from blackwell_testing.modules.analysisd import patterns, utils, configuration as analysisd_config
...
monitored_sockets_params = [(BLACKWELL_DB_DAEMON, None, None), (ANALYSISD_DAEMON, mitm_analysisd, True)]
...
def test_validate_all_win32_registry_alerts(test_metadata, configure_local_internal_options, truncate_monitored_files_module,
    ...
    '''
    description: Check if the alerts generated by the 'blackwell-analysisd' daemon from Windows registry-related
