...
brief: This module verifies the correct behavior of 'blackwell-authd' under different messages
...
from blackwell_testing.constants.paths.sockets import BLACKWELL_DB_SOCKET_PATH, AUTHD_SOCKET_PATH
...
# Variables
receiver_sockets_params = [(AUTHD_SOCKET_PATH, 'AF_UNIX', 'TCP'), (BLACKWELL_DB_SOCKET_PATH, 'AF_UNIX', 'TCP')]

daemons_handler_configuration = {'all_daemons': True}

# TODO Replace or delete
monitored_sockets_params = [(BLACKWELL_DB_DAEMON, None, True), (AUTHD_DAEMON, None, True)]
receiver_sockets, monitored_sockets = None, None


# Tests
@pytest.mark.parametrize('test_configuration,test_metadata', zip(test_configuration, test_metadata), ids=test_cases_ids)
def test_authd_local_messages(test_configuration, test_metadata, set_blackwell_configuration, configure_sockets_environment_module,
