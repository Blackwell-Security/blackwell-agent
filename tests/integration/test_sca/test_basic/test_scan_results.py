...
references:
    - https://documentation.blackwell.com/current/user-manual/capabilities/sec-config-assessment/index.html
...
from blackwell_testing.modules.modulesd.sca import patterns
...
def test_sca_scan_results(test_configuration, test_metadata, prepare_cis_policies_file, truncate_monitored_files,
                          set_blackwell_configuration, configure_local_internal_options, daemons_handler,
    ...
    parameters:
        - configuration:
            type: dict
            brief: Blackwell configuration data. Needed for set_blackwell_configuration fixture.
        - metadata:
            type: dict
            brief: Blackwell configuration metadata.
        - prepare_cis_policies_file:
            type: fixture
            brief: copy test sca policy file. Delete it after test.
        - set_blackwell_configuration:
            type: fixture
            brief: Set the blackwell configuration according to the configuration data.
        ...
        - restart_modulesd_function:
            type: fixture
            brief: Restart the blackwell-modulesd daemon.
        - wait_for_sca_enabled:
            type: fixture
