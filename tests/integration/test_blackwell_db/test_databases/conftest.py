...
from blackwell_testing.utils.db_queries.global_db import create_or_update_agent, delete_agent
...
def pre_insert_packages():
    ...
    for pkg_n in range(PACKAGES_NUMBER):
        agent_db.insert_package(scan_id='0', scan_time='2021/04/07 22:00:00', format='deb', name=f'test_package_{pkg_n}',
                                priority='optional', section='utils', size=f'{random.randint(200,1000)}', vendor='Blackwell blackwell@blackwell.com',
