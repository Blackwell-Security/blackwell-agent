...
from blackwell_testing.utils.db_queries.global_db import get_agent_info
...
def test_set_agent_groups(clean_databases, daemons_handler, test_metadata, create_groups):
    '''
    description: Check that every input message using the 'set_agent_groups' command in blackwell-db socket generates
