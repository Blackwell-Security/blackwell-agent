...
config_path = Path(CONFIGURATIONS_PATH, 'blackwell_basic_configuration_target.yaml')
...
def test_configuration_target(test_configuration, test_metadata, set_blackwell_configuration, configure_local_internal_options, daemons_handler_module, stop_logcollector):
    '''
    description: Check if the 'blackwell-logcollector' daemon detects invalid configurations for the 'target' attribute
                 ...
                 the Blackwell API returns the same values for the 'localfile' section that the configured one.
