...
references:
    ...
    - https://documentation.blackwell.com/current/user-manual/reference/ossec-conf/localfile.html#reconnect-time
...
config_path = Path(CONFIGURATIONS_PATH, 'blackwell_basic_configuration_reconnect_time.yaml')
...
def test_configuration_reconnect_time(test_configuration, test_metadata, truncate_monitored_files,
    ...
    '''
    description: Check if the 'blackwell-logcollector' daemon detects invalid settings for the 'reconnect_time' tag.
    ...
    if test_metadata['valid_value']:
        ...
        if test_metadata['reconnect_time'] in problematic_values:
            ...
            assert (blackwell_log_monitor.callback_result != None), patterns.ERROR_INVALID_RECONNECTION_TIME
