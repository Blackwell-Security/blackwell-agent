...
def test_aws_service_initializes_properly(mock_blackwell_integration, mock_version, mock_path, mock_client, mock_connect,
    ...
    mock_blackwell_integration.assert_called_with(instance, service_name=utils.TEST_SERVICE_NAME,
...
@patch('blackwell_integration.BlackwellIntegration.__init__', side_effect=blackwell_integration.BlackwellIntegration.__init__)
def test_aws_service_get_last_log_date(mock_blackwell_integration, mock_blackwell_aws_database, mock_sts):
...
@patch('blackwell_integration.BlackwellAWSDatabase.__init__')
@patch('blackwell_integration.BlackwellIntegration.__init__', side_effect=blackwell_integration.BlackwellIntegration.__init__)
def test_aws_service_format_message(mock_blackwell_integration, mock_blackwell_aws_database, mock_sts):
