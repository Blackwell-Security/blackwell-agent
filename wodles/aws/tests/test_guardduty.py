...
def test_aws_guardduty_bucket_check_guardduty_type(mock_blackwell_aws_integration, mock_sts,
...
@patch('blackwell_integration.BlackwellIntegration.get_sts_client')
@patch('blackwell_integration.BlackwellAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_blackwell_aws_integration, mock_sts):
...
@patch('blackwell_integration.BlackwellIntegration.get_sts_client')
@patch('blackwell_integration.BlackwellAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_blackwell_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('blackwell_integration.BlackwellIntegration.get_sts_client')
@patch('blackwell_integration.BlackwellAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_blackwell_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('blackwell_integration.BlackwellIntegration.get_sts_client')
@patch('blackwell_integration.BlackwellAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_blackwell_aws_integration, mock_sts, guardduty_native: bool):
