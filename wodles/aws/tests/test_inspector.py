...
def test_aws_inspector_send_describe_findings(mock_sts_client):
    ...
    with patch('blackwell_integration.BlackwellIntegration.send_msg') as mock_send_msg, \
...
@patch('blackwell_integration.BlackwellAWSDatabase.init_db')
@patch('blackwell_integration.BlackwellAWSDatabase.close_db')
