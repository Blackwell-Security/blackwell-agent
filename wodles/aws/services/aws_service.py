...
class AWSService(blackwell_integration.BlackwellAWSDatabase):
    """
    ...
    def __init__(self, reparse: bool, access_key: str, secret_key: str, profile: str, iam_role_arn: str,
        ...
        blackwell_integration.BlackwellAWSDatabase.__init__(self, db_name=self.db_name, service_name=service_name,
