...
try:
    ...
    raise exceptions.BlackwellIntegrationException(errcode=1003, package=e.name)


class BlackwellGCloudBucket(BlackwellGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, logger: logging.Logger, bucket_name: str, prefix: str = None,
        ...
        self.db_path = join(utils.find_blackwell_path(), "wodles/gcloud/gcloud.db")
