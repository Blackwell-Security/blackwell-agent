...
class BlackwellIntegrationException(Exception):
    """Class that represents an exception for the Blackwell external integrations.
...
class BlackwellIntegrationInternalError(BlackwellIntegrationException):
    """Class that represents a critical exception for the Blackwell external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudBlackwellNotRunning',
            'message': 'Blackwell must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Blackwell'
        },
    }

class GCloudError(BlackwellIntegrationException):
