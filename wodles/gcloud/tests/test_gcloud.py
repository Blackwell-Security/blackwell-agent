...
@patch('gcloud.BlackwellGCloudSubscriber')
...
@patch('pubsub.subscriber.BlackwellGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.BlackwellGCloudSubscriber.process_messages')
