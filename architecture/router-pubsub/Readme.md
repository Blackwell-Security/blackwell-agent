...
# Blackwell module: Router PubSub architecture
## Index
- [Blackwell module: Router PubSub architecture](#blackwell-module-router-pubsub-architecture)
  - [Index](#index)
  - [Purpose](#purpose)
...
- 001-sequence-initialize: It explains the blackwell module router initialization, construction, use, destruction and stop from the blackwell modules daemon perspective.
