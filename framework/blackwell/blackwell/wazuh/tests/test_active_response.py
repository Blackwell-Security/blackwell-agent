...
with patch('blackwell.core.common.blackwell_uid'):
    with patch('blackwell.core.common.blackwell_gid'):
        ...
        from blackwell.active_response import run_command
        from blackwell.core.tests.test_active_response import agent_config, agent_info_exception_and_version
...
@pytest.mark.parametrize('message_exception, send_exception, agent_id, command, arguments, alert, version', [
    (1701, None, ['999'], 'restart-blackwell0', [], None, 'Blackwell v4.0.0'),
    (1703, None, ['000'], 'restart-blackwell0', [], None, 'Blackwell v4.0.0'),
    (1650, None, ['001'], None, [], None, 'Blackwell v4.0.0'),
    (1652, None, ['002'], 'random', [], None, 'Blackwell v4.0.0'),
    (None, 1707, ['003'], 'restart-blackwell0', [], None, None),
    (None, 1750, ['004'], 'restart-blackwell0', [], None, 'Blackwell v4.0.0'),
    (None, None, ['005'], 'restart-blackwell0', [], None, 'Blackwell v4.0.0'),
    (None, None, ['006'], '!custom-ar', [], None, 'Blackwell v4.0.0'),
    (None, None, ['007'], 'restart-blackwell0', ["arg1", "arg2"], None, 'Blackwell v4.0.0'),
    (None, None, ['001', '002', '003', '004', '005', '006'], 'restart-blackwell0', [], None, 'Blackwell v4.0.0'),
    (None, None, ['001'], 'restart-blackwell0', ["arg1", "arg2"], None, 'Blackwell v4.2.0'),
    (None, None, ['002'], 'restart-blackwell0', [], None, 'Blackwell v4.2.1'),
])
@patch("blackwell.core.blackwell_queue.BlackwellQueue._connect")
@patch("blackwell.syscheck.BlackwellQueue._send", return_value='1')
@patch("blackwell.core.blackwell_queue.BlackwellQueue.close")
@patch('blackwell.core.common.AR_CONF', new=test_data_path)
@patch('blackwell.active_response.get_agents_info', return_value=full_agent_list)
def test_run_command(mock_get_agents_info, mock_close, mock_send, mock_conn, message_exception,
    ...
    """
    with patch('blackwell.core.agent.Agent.get_basic_information',
               return_value=agent_info_exception_and_version(send_exception, version)):
        with patch('blackwell.core.agent.Agent.get_config', return_value=agent_config(send_exception)):
