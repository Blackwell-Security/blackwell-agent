...
from blackwell.rbac import orm
...
class RBAChecker:
    ...
    def check_logic_operation(self, rule_key: str, rule_value: dict, validator_counter: int) -> Union[bool, None]:
        ...
        -------
        bool or None
            True/False/None, it is possible that the database has been modified externally to Blackwell, Potential Security
