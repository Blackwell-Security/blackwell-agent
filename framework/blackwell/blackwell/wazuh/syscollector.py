...
from blackwell.core.results import AffectedItemsBlackwellResult, merge
from blackwell.core.syscollector import BlackwellDBQuerySyscollector, get_valid_fields, Type
...
def get_item_agent(agent_list: list, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: dict = None,
                   ...
                   nested: bool = True, element_type: str = 'os', distinct: bool = False) -> AffectedItemsBlackwellResult:
    ...
    for agent in agent_list:
        try:
            ...
            with BlackwellDBQuerySyscollector(agent_id=agent, offset=offset, limit=limit, select=select,
                                          search=search,
        ...
        except BlackwellResourceNotFound as e:
