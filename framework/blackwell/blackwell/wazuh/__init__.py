...
from blackwell.core.exception import BlackwellException, BlackwellError, BlackwellInternalError

"""
Blackwell HIDS Python package
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Blackwell is a python package to manage OSSEC.
...
try:
    ...
    if python_version.major < 2 or (python_version.major == 2 and python_version.minor < 7):
        raise BlackwellInternalError(999, msg)
...
class Blackwell:
    ...
    def __init__(self):
        ...
        self.type = 'server'
        self.path = common.BLACKWELL_PATH
    ...
    def _initialize(self):
        """
        Calculates all Blackwell installation metadata
        """
        # info DB if possible
        try:
