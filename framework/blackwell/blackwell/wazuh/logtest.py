...
from blackwell.core.logtest import send_logtest_msg
...
def run_logtest(token: str = None, event: str = None, log_format: str = None, location: str = None) -> dict:
    ...
    if response['error'] != 0:
        raise BlackwellError(7000, extra_message=response.get('message', 'Could not parse error message'))
