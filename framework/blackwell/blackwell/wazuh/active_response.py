...
from blackwell.core import active_response, common
from blackwell.core.agent import get_agents_info
from blackwell.core.exception import BlackwellException, BlackwellError, BlackwellResourceNotFound
...
def run_command(agent_list: list = None, command: str = '', arguments: list = None,
                alert: dict = None) -> AffectedItemsBlackwellResult:
    ...
    AffectedItemsBlackwellResult
        Affected items.
    """
    result = AffectedItemsBlackwellResult(all_msg='AR command was sent to all agents',
