...
from blackwell.core.cluster import __version__
from blackwell.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "Blackwell Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class BlackwellException(Exception):
    """
    Blackwell Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Blackwell API',
        ...
        1000: {'message': 'Blackwell Internal Error',
               'remediation': 'Please, check `BLACKWELL_HOME/logs/ossec.log`, `BLACKWELL_HOME/logs/cluster.log` and '
                              '`BLACKWELL_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Blackwell directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `blackwell` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Blackwell to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Blackwell directories'},
        1017: 'Some Blackwell daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Blackwell log file',
               'remediation': 'Please check `BLACKWELL_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `BLACKWELL_PATH/bin/blackwell-logtest -t` to check your configuration'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.blackwell.com/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.blackwell.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'blackwell' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in BLACKWELL_PATH/api/configuration/api.yaml'},
        1123: {
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `BLACKWELL_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1131: {'message': 'Virus Total API request error',
               'remediation': 'The use of Virus Total Public API keys is disabled but could not be checked. '
                              ...
                              f"https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `BLACKWELL_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.blackwell.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1209: {'message': 'Invalid relative directory. A \'rule_dir\' tag must '
               ...
               'remediation': f'Please, visit the official documentation '
                              f'(https://documentation.blackwell.com/'
        ...
        1211: {'message': 'Invalid relative directory. A \'rule_dir\' tag is declared in ossec.conf '
               ...
               'remediation': f'Please, visit the official documentation'
                               '(https://documentation.blackwell.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/ruleset.html)'
                              ' to get more information about the rules'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'Blackwell authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.blackwell.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        ...
        1743: 'Error running Blackwell syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `BLACKWELL_HOME/etc/ossec.conf`"},
        ...
        2003: {'message': 'Error in blackwelldb request',
        ...
        2006: {'message': 'Received JSON from Blackwell DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Blackwell DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Blackwell service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from blackwell-db was over the maximum socket buffer size'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `BLACKWELL_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.blackwell.com/'
                              f'{DOCU_VERSION}/user-manual/configuring-cluster/index.html)'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'Blackwell is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at BLACKWELL_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `blackwell-manager` service.'},
        3024: "Length of command exceeds limit defined in blackwell.cluster.common.Handler.cmd_len.",
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[ossec.conf](https://documentation.blackwell.com/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.blackwell.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `blackwell-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.blackwell.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `blackwell-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.blackwell.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#name)"
                              " in the worker configuration to match the master's and restart the `blackwell-manager` "
                              "service"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.blackwell.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"blackwell.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct Blackwell\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (blackwell) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.blackwell.com/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: BLACKWELL_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.blackwell.com/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a BlackwellException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Blackwell Internal error',
            'logfile': BLACKWELL_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, BlackwellException):
    ...
    def __or__(self, other):
        if isinstance(other, BlackwellException):
...
class BlackwellInternalError(BlackwellException):
    """
    ...
    _default_title = "Blackwell Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a BlackwellInternalError exception.
...
class BlackwellClusterError(BlackwellInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Blackwell Cluster Error"


class BlackwellHAPHelperError(BlackwellClusterError):
    """
...
class BlackwellError(BlackwellException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a BlackwellError exception.
    ...
    def __or__(self, other):
        result: BlackwellError = super().__or__(other)
        if isinstance(result, BlackwellError):
...
class BlackwellPermissionError(BlackwellError):
    """
...
class BlackwellResourceNotFound(BlackwellError):
    """
...
class BlackwellTooManyRequests(BlackwellError):
    """
...
class BlackwellNotAcceptable(BlackwellError):
    """
