...
class BlackwellDBQueryRootcheck(BlackwellDBQuery):
    """Rootcheck BlackwellDBQuery object."""
    fields = {
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, sort: dict, search: dict, select: list, query: str,
        ...
        backend = BlackwellDBBackend(agent_id)
        BlackwellDBQuery.__init__(self, offset=offset, limit=limit, table='pm_event', sort=sort, search=search,
    ...
    def _filter_status(self, filter_status: dict):
        ...
        if filter_status['value'] == 'all':
            ...
            raise BlackwellException(1603, filter_status['value'])
...
def rootcheck_delete_agent(agent: str, wdb_conn: BlackwellDBConnection) -> None:
