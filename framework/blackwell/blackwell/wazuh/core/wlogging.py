...
class TimeBasedFileRotatingHandler(logging.handlers.TimedRotatingFileHandler):
    """
    Blackwell log rotation. It rotates the log at midnight and sets the appropriate permissions to the new log file.
    """
    ...
    def doRollover(self):
        ...
        # Save rotated file in {BLACKWELL_PATH}/logs/api directory
...
class SizeBasedFileRotatingHandler(logging.handlers.RotatingFileHandler):
    """Blackwell log rotation. It rotates when the logging file size exceeds the maximum number of bytes configured."""
...
class BlackwellLogger:
    """
    Define attributes of a Python Blackwell daemon's logger.
    """
    def __init__(self, foreground_mode: bool, log_path: str, debug_level: [int, str], logger_name: str = 'blackwell',
        ...
        log_path : str
            Filepath of the file to send logs to. Relative to the Blackwell installation path.
        ...
        """
        self.log_path = os.path.join(common.BLACKWELL_PATH, log_path)
        self.logger = None
