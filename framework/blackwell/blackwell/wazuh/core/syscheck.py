...
from blackwell.core.utils import BlackwellDBQuery, BlackwellDBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from blackwell.core.wdb import BlackwellDBConnection


class BlackwellDBQuerySyscheck(BlackwellDBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=BlackwellDBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: BlackwellDBConnection) -> None:
