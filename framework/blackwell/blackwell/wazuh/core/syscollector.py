...
from blackwell.core.utils import plain_dict_to_nested_dict, get_fields_to_nest, BlackwellDBQuery, BlackwellDBBackend
...
class BlackwellDBQuerySyscollector(BlackwellDBQuery):
    ...
    def __init__(self, array, nested, agent_id, *args, **kwargs):
        super().__init__(backend=BlackwellDBBackend(agent_id), default_sort_field='scan_id', get_data=True, count=True,
                         *args, **kwargs)
        self.array = array
        self.nested = nested
