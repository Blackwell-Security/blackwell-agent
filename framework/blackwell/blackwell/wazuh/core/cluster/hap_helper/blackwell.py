...
class BlackwellAgent:
    """Tools to handle Blackwell agents connections."""
...
class BlackwellDAPI:
    """Class to call Blackwell DAPI functions."""
    ...
    def _get_logger(tag: str) -> logging.Logger:
        ...
        """
        logger = logging.getLogger('blackwell').getChild('BlackwellDAPI')
