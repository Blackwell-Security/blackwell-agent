...
from blackwell.core.utils import BlackwellDBQuery, BlackwellDBBackend, get_date_from_timestamp
...
class BlackwellDBQuerySCA(BlackwellDBQuery):
    ...
    def __init__(self, agent_id: str, offset: int, limit: Union[int, None], sort: Union[dict, None],
        ...
        self.default_query = default_query if default_query else \
            BlackwellDBQuerySCA.DEFAULT_QUERY if not distinct else BlackwellDBQuerySCA.DEFAULT_QUERY_DISTINCT
        Agent(agent_id).get_basic_information()  # check if the agent exists

        BlackwellDBQuery.__init__(self, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                              ...
                              min_select_fields=min_select_fields, backend=BlackwellDBBackend(agent_id))
...
class BlackwellDBQuerySCACheck(BlackwellDBQuerySCA):
    ...
    def __init__(self, agent_id: str, select: list, sort: dict, sca_checks_ids: list):
        ...
        BlackwellDBQuerySCA.__init__(self, agent_id=agent_id, offset=0, limit=None, sort=sort, filters={}, search=None,
    ...
    def _parse_select_filter(self, select_fields):
        if select_fields:
            ...
            if not set_select_fields or not set_select_fields.issubset(set_fields_keys):
                ...
                raise BlackwellError(1724, "Allowed select fields: {0}. Fields {1}".format(
...
class BlackwellDBQuerySCACheckIDs(BlackwellDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        BlackwellDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters=filters,
...
class BlackwellDBQuerySCACheckRelational(BlackwellDBQuerySCA):
    ...
    def __init__(self, agent_id: str, table: str, id_check_list: list, select: list):
        ...
        BlackwellDBQuerySCA.__init__(self, agent_id=agent_id, default_query=default_query,
...
class BlackwellDBQueryDistinctSCACheck(BlackwellDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        with BlackwellDBQuerySCA(agent_id=agent_id, offset=0, limit=None, sort=sort,
        ...
        BlackwellDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters={}, search={},
