...
from blackwell.core.utils import BlackwellDBQuery, BlackwellDBBackend, get_utc_strptime
from blackwell.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each BlackwellDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default BlackwellDBQueryMitre request_slice value
...
class BlackwellDBQueryMitre(BlackwellDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the BlackwellDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the BlackwellDBBacked backend object.
        distinct : bool
        ...
        BlackwellDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=BlackwellDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class BlackwellDBQueryMitreMetadata(BlackwellDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the BlackwellDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        BlackwellDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class BlackwellDBQueryMitreRelational(BlackwellDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of BlackwellDBQueryMitre.
...
class BlackwellDBQueryMitreRelationalPhase(BlackwellDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the BlackwellDBQueryMitreRelationalPhase class.
...
class BlackwellDBQueryMitreRelationalMitigate(BlackwellDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the BlackwellDBQueryMitreRelationalMitigate class.
...
class BlackwellDBQueryMitreRelationalUse(BlackwellDBQueryMitreRelational):
...
class BlackwellDBQueryMitreMitigations(BlackwellDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the BlackwellDBQueryMitreMitigations class.
        ...
        BlackwellDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with BlackwellDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with BlackwellDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class BlackwellDBQueryMitreReferences(BlackwellDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the BlackwellDBQueryMitreReferences class.
...
class BlackwellDBQueryMitreTactics(BlackwellDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BlackwellDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with BlackwellDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with BlackwellDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BlackwellDBQueryMitreTechniques(BlackwellDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BlackwellDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with BlackwellDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with BlackwellDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with BlackwellDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with BlackwellDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with BlackwellDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BlackwellDBQueryMitreGroups(BlackwellDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the BlackwellDBQueryMitreGroups class.
        ...
        BlackwellDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with BlackwellDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with BlackwellDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class BlackwellDBQueryMitreSoftware(BlackwellDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with BlackwellDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        BlackwellDBQueryMitre class used to obtain certain MITRE resources.
