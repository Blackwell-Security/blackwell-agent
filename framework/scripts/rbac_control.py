...
async def restore_default_passwords(script_args):
    ...
    from blackwell.core.common import DEFAULT_RBAC_RESOURCES
    from blackwell.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from blackwell.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Blackwell RBAC tool: manage resources from the Blackwell RBAC database")
