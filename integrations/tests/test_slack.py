# Copyright (C) 2023, Blackwell Inc.
...
alert_template = {
    ...
    'location': 'blackwell-X',
}

options_template = {'pretext': 'Blackwell-X -- Alert generated', 'author_name': 'The amazing Blackwell', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Blackwell-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "blackwell-X", "author_name": "The amazing Blackwell",'
    '"footer": "Slack API"}'
)
slack_webhook = ''
