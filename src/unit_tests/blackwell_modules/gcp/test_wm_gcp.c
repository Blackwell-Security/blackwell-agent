...
#include "../../blackwell_modules/wm_gcp.h"
#include "../../headers/defs.h"
#include "../../wrappers/externals/cJSON/cJSON_wrappers.h"
#include "../../wrappers/blackwell/shared/debug_op_wrappers.h"
#include "../../wrappers/blackwell/shared/schedule_scan_wrappers.h"
#include "../../wrappers/blackwell/shared/time_op_wrappers.h"
...
static void test_wm_gcp_pubsub_run_error_running_command(void **state)  {
    ...
    snprintf(gcp_config->project_id, OS_SIZE_1024, "blackwell-gcp-test");
    snprintf(gcp_config->subscription_name, OS_SIZE_1024, "blackwell-subscription-test");
    snprintf(gcp_config->credentials_file, OS_SIZE_1024, "/blackwell/credentials/test.json");
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type pubsub --project blackwell-gcp-test --subscription_id blackwell-subscription-test "
        "--credentials_file /blackwell/credentials/test.json --max_messages 10 --num_threads 2 --log_level 1");
...
static void test_wm_gcp_pubsub_run_generic_error(void **state) {
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type pubsub --project blackwell-gcp-test --subscription_id blackwell-subscription-test "
        "--credentials_file /blackwell/credentials/test.json --max_messages 10 --num_threads 2");
...
static void test_wm_gcp_pubsub_run_logging_debug_message_not_debug_discarded(void **state) {
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type pubsub --project blackwell-gcp-test --subscription_id blackwell-subscription-test "
        "--credentials_file /blackwell/credentials/test.json --max_messages 10 --num_threads 2 --log_level 2");
...
static void test_wm_gcp_pubsub_run_logging_default_message_debug(void **state) {
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type pubsub --project blackwell-gcp-test --subscription_id blackwell-subscription-test "
        "--credentials_file /blackwell/credentials/test.json --max_messages 10 --num_threads 2 --log_level 6");
...
static void test_wm_gcp_pubsub_dump_success_logging_debug(void **state) {
    ...
    snprintf(gcp_pubsub_dump_data->config->project_id, OS_SIZE_1024, "blackwell-gcp-test");
    snprintf(gcp_pubsub_dump_data->config->subscription_name, OS_SIZE_1024, "blackwell-subscription-test");
    snprintf(gcp_pubsub_dump_data->config->credentials_file, OS_SIZE_1024, "/blackwell/credentials/test.json");
    ...
    assert_string_equal(cJSON_GetStringValue(project_id), "blackwell-gcp-test");
    cJSON *subscription_name = cJSON_GetObjectItem(gcp_pubsub, "subscription_name");
    assert_string_equal(cJSON_GetStringValue(subscription_name), "blackwell-subscription-test");
    cJSON *credentials_file = cJSON_GetObjectItem(gcp_pubsub, "credentials_file");
    assert_string_equal(cJSON_GetStringValue(credentials_file), "/blackwell/credentials/test.json");
}
...
static void test_wm_gcp_bucket_run_success(void **state) {
    ...
    snprintf(cur_bucket->bucket, OS_SIZE_1024, "blackwell-gcp-test");
    snprintf(cur_bucket->type, OS_SIZE_1024, "access_logs");
    snprintf(cur_bucket->credentials_file, OS_SIZE_1024, "/blackwell/credentials/test.json");
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type access_logs --bucket_name blackwell-gcp-test "
        "--credentials_file /blackwell/credentials/test.json --prefix access_logs/ --only_logs_after 2021-JAN-01 --remove");
...
static void test_wm_gcp_bucket_run_logging_debug_message_debug(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, WM_GCP_BUCKET_LOGTAG);
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type access_logs --bucket_name blackwell-gcp-test --credentials_file "
        "/blackwell/credentials/test.json --prefix access_logs/ --only_logs_after 2021-JAN-01 --remove --log_level 2");
...
static void test_wm_gcp_bucket_run_logging_info_message_info(void **state) {
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type access_logs --bucket_name blackwell-gcp-test --credentials_file "
        "/blackwell/credentials/test.json --prefix access_logs/ --only_logs_after 2021-JAN-01 --remove --log_level 1");
...
static void test_wm_gcp_bucket_run_logging_warning_message_warning(void **state) {
    ...
    expect_string(__wrap__mtdebug1, formatted_msg, "Launching command: "
        "wodles/gcloud/gcloud --integration_type access_logs --bucket_name blackwell-gcp-test --credentials_file "
        "/blackwell/credentials/test.json --prefix access_logs/ --only_logs_after 2021-JAN-01 --remove");
...
static void test_wm_gcp_bucket_dump_success_logging_debug(void **state) {
    ...
    assert_string_equal(cJSON_GetStringValue(bucket), "blackwell-gcp-test");
...
static void test_wm_gcp_bucket_main_run_on_start(void **state) {
    ...
    expect_string(__wrap__mtinfo, tag, WM_GCP_BUCKET_LOGTAG);
    expect_string(__wrap__mtinfo, formatted_msg, "Executing Bucket Analysis: (Bucket: blackwell-gcp-test, "
        "Path: access_logs/, Type: access_logs, Credentials file: /blackwell/credentials/test.json)");
