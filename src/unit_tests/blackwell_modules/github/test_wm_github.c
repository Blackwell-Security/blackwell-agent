...
#include "../../../blackwell_modules/wm_github.h"
#include "../../../blackwell_modules/wm_github.c"

#include "../scheduling/wmodules_scheduling_helpers.h"
#include "../../wrappers/common.h"
#include "../../wrappers/libc/stdlib_wrappers.h"
#include "../../wrappers/blackwell/os_regex/os_regex_wrappers.c"
#include "../../wrappers/blackwell/shared/mq_op_wrappers.h"
#include "../../wrappers/blackwell/blackwell_modules/wmodules_wrappers.h"
...
static int teardown_conf(void **state) {
    ...
    test_mode = 0;
    expect_string(__wrap__mtinfo, tag, "blackwell-modulesd:github");
...
void test_github_main_fail_StartMQ(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:github");
...
void test_github_scan_failure_action_3(void **state) {
    ...
    expect_string(__wrap_wm_sendmsg, message, "{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\",\"organization\":\"test_org\",\"event_type\":\"test_event\",\"response\":\"Unknown error\"}}");
    ...
    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:github");
    expect_string(__wrap__mtwarn, formatted_msg, "Sending GitHub internal message: '{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\",\"organization\":\"test_org\",\"event_type\":\"test_event\",\"response\":\"Unknown error\"}}'");
...
void test_github_scan_failure_action_4(void **state) {
    ...
    expect_value(__wrap_wm_sendmsg, usec, 1000000);
    expect_value(__wrap_wm_sendmsg, queue, 1);
    expect_string(__wrap_wm_sendmsg, message, "{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\",\"organization\":\"test_org\",\"event_type\":\"test_event\",\"response\":\"{\\\"test\\\":\\\"test_error\\\"}\"}}");
    expect_string(__wrap_wm_sendmsg, locmsg, "github");
    expect_value(__wrap_wm_sendmsg, loc, LOCALFILE_MQ);
    will_return(__wrap_wm_sendmsg, result);

    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:github");
    expect_string(__wrap__mtwarn, formatted_msg, "Sending GitHub internal message: '{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\",\"organization\":\"test_org\",\"event_type\":\"test_event\",\"response\":\"{\\\"test\\\":\\\"test_error\\\"}\"}}'");
...
void test_github_execute_scan(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:github");
...
void test_github_execute_scan_status_code_200_null(void **state) {
    ...
    os_calloc(1, sizeof(curl_response), data->response);
    data->response->status_code = 200;
    os_strdup("{\"github\":{\"actor\":\"blackwell\"}}", data->response->body);
    ...
    expect_string(__wrap_wm_sendmsg, message, "{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\"}}");
    expect_string(__wrap_wm_sendmsg, locmsg, "github");
    expect_value(__wrap_wm_sendmsg, loc, LOCALFILE_MQ);
    will_return(__wrap_wm_sendmsg, 0);

    expect_string(__wrap__mtdebug2, tag, "blackwell-modulesd:github");
    expect_string(__wrap__mtdebug2, formatted_msg, "Sending GitHub log: '{\"integration\":\"github\",\"github\":{\"actor\":\"blackwell\"}}'");
...
void test_read_configuration(void **state) {
    const char *string =
        ...
        "<api_auth>"
            "<org_name>Blackwell</org_name>"
            "<api_token>Blackwell_token</api_token>"
        "</api_auth>"
        "<api_parameters>"
    ...
    assert_string_equal(module_data->auth->org_name, "Blackwell");
    assert_string_equal(module_data->auth->api_token, "Blackwell_token");
...
void test_read_configuration_1(void **state) {
    const char *string =
        ...
        "</api_auth>"
        "<api_auth>"
            "<org_name>Blackwell1</org_name>"
            "<api_token>Blackwell_token1</api_token>"
        "</api_auth>"
        "<api_parameters>"
            "<event_type>git</event_type>"
        "</api_parameters>"
    ...
    assert_string_equal(module_data->auth->org_name, "Blackwell");
    assert_string_equal(module_data->auth->api_token, "Blackwell_token");
    assert_string_equal(module_data->auth->next->org_name, "Blackwell1");
    assert_string_equal(module_data->auth->next->api_token, "Blackwell_token1");
    assert_string_equal(module_data->event_type, "git");
}
...
void test_error_api_auth_1(void **state) {
    const char *string =
        ...
        "<only_future_events>no</only_future_events>"
        "<api_auth>"
            "<invalid>Blackwell</invalid>"
            "<invalid>Blackwell_token</invalid>"
        "</api_auth>"
        "<api_parameters>"
            "<event_type>all</event_type>"
        "</api_parameters>"
