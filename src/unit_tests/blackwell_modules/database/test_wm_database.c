...
#include <shared.h>
#include "../../../blackwell_modules/wmodules_def.h"
#include "../../../blackwell_modules/wm_database.h"
...
void test_wm_sync_group_file_error_agent_id(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:database");
...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "blackwell-modulesd:database");
...
void test_sync_keys_with_wdb_insert_delete(void **state) {
    ...
    expect_string(__wrap_wdbc_query_ex, query, "blackwelldb remove 1");
    expect_value(__wrap_wdbc_query_ex, len, OS_SIZE_1024);
    will_return(__wrap_wdbc_query_ex, "ok");
    will_return(__wrap_wdbc_query_ex, -1);

    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:database");
    expect_string(__wrap__mtdebug1, formatted_msg, "Could not remove the blackwell-db DB of the agent 1.");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:database");
