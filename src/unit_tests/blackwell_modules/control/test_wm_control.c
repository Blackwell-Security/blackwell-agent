...
#include <cmocka.h>
#include <stdio.h>
#include "../../wrappers/blackwell/data_provider/sysInfo_wrappers.h"
#include "../../../data_provider/include/sysInfo.h"
#include "../../../blackwell_modules/wm_control.h"
...
static void test_wm_control_getPrimaryIP_sysinfo_network_return_error(void ** state) {
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:control");
