...
#include "../../wrappers/blackwell/shared/cluster_op_wrappers.h"
#include "../../wrappers/blackwell/shared/debug_op_wrappers.h"
#include "../../wrappers/blackwell/shared/pthreads_op_wrappers.h"
#include "../../wrappers/blackwell/os_net/os_net_wrappers.h"
#include "../../wrappers/blackwell/blackwell_modules/wm_task_manager_wrappers.h"

#include "../../blackwell_modules/wmodules.h"
#include "../../blackwell_modules/task_manager/wm_task_manager.h"
#include "../../blackwell_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "blackwell-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:task-manager");
