...
#include "../../blackwell_modules/wm_ms_graph.h"
#include "../../blackwell_modules/wm_ms_graph.c"
...
void test_main_token(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:ms-graph");
...
void test_wm_ms_graph_get_access_token_no_response(void **state) {
    ...
    */
    ...
    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:ms-graph");
...
void test_wm_ms_graph_scan_relationships_single_no_logs(void **state) {
    ...
    */
    ...
    expect_string(__wrap__mtdebug2, tag, "blackwell-modulesd:ms-graph");
...
void test_wm_ms_graph_scan_relationships_single_success_two_resources(void **state) {
    ...
    */
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:ms-graph");
    expect_string(__wrap__mterror, formatted_msg, "Couldn't save running state.");
