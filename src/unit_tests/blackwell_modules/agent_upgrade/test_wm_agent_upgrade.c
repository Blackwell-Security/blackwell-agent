...
#include "../../wrappers/blackwell/blackwell_modules/wm_agent_upgrade_agent_wrappers.h"

#include "../../blackwell_modules/wmodules.h"
#include "../../blackwell_modules/agent_upgrade/wm_agent_upgrade.h"
...
void test_wm_agent_upgrade_dump_enabled(void **state)
{
    ...
    #ifdef TEST_SERVER
    os_strdup("blackwell.com/packages", config->manager_config.wpk_repository);
    ...
    assert_string_equal(cJSON_GetObjectItem(conf, "wpk_repository")->valuestring, "blackwell.com/packages");
    #else
