...
#include "../../wrappers/blackwell/shared/url_wrappers.h"
#include "../../wrappers/blackwell/os_crypto/sha1_op_wrappers.h"
#include "../../wrappers/blackwell/blackwell_db/wdb_wrappers.h"
#include "../../wrappers/blackwell/blackwell_modules/wm_agent_upgrade_wrappers.h"

#include "../../blackwell_modules/wmodules.h"
#include "../../blackwell_modules/agent_upgrade/manager/wm_agent_upgrade_validate.h"
#include "../../blackwell_modules/agent_upgrade/manager/wm_agent_upgrade_tasks.h"
...
void test_wm_agent_upgrade_validate_wpk_version_windows_https_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_http_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v3.13.1_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_windows_invalid_repo(void **state)
{
    wm_agent_info *agent = state[0];
    wm_upgrade_task *task = state[1];
    char *repo = "error.blackwell.com/wpk/";
    char *versions = NULL;
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.blackwell.com/wpk/windows/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_linux_https_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.0.0_linux_x64.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_http_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v3.13.1_linux_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_invalid_repo(void **state)
{
    ...
    expect_string(__wrap_wurl_http_get, url, "http://error.blackwell.com/wpk/linux/x64/versions");
    expect_value(__wrap_wurl_http_get, timeout, WM_UPGRADE_DEFAULT_REQUEST_TIMEOUT);
    will_return(__wrap_wurl_http_get, versions);
...
void test_wm_agent_upgrade_validate_wpk_version_ubuntu_old_version(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v3.3.0_ubuntu_16.04_x64.wpk");
...
void test_wm_agent_upgrade_validate_wpk_version_rhel_old_version(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v3.3.0_rhel_6_x86.wpk");
    assert_string_equal(task->wpk_sha1, "ad87687f6876e876876bb86ad54e57aa");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_https_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.0.0_macos_x64.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_http_ok(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v3.13.1_macos_x64.wpk");
    assert_string_equal(task->wpk_sha1, "4a313b1312c23a213f2e3209fe0909dd");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_x86_64(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_macos_intel64.pkg.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_macos_aarch64(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_macos_arm64.pkg.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_x86_64(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_x86_64.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_aarch64(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_aarch64.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb(void **state)
{
    ...
    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_rpm_deb_force(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:agent-upgrade");
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_amd64.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_deb_aarch64(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_arm64.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_rpm(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_i386.rpm.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
void test_wm_agent_upgrade_validate_wpk_version_linux_package_unsupported_deb(void **state)
{
    ...
    assert_string_equal(task->wpk_file, "blackwell_agent_v4.9.0_linux_i386.deb.wpk");
    assert_string_equal(task->wpk_sha1, "231ef123a32d312b4123c21313ee6780");
}
...
{
    wm_upgrade_task *task = state[1];
    char *blackwell_version = "v3.9.1";
    char *platform = "ubuntu";

    task->force_upgrade = false;

    int ret = wm_agent_upgrade_validate_version(blackwell_version, platform, WM_UPGRADE_UPGRADE, task);
...
void test_wm_agent_upgrade_validate_version_upgrade_custom_ok(void **state)
{
    ...
    int ret = wm_agent_upgrade_validate_version(blackwell_version, platform, WM_UPGRADE_UPGRADE_CUSTOM, task);
...
{
    wm_upgrade_task *task = state[1];
    char *blackwell_version = "v3.13.1";
    char *platform = "ubuntu";
...
void test_wm_agent_upgrade_validate_wpk_exist(void **state)
{
    ...
    os_strdup("blackwell_agent_v4.0.0_windows.wpk", task->wpk_file);
    os_strdup(sha1, task->wpk_sha1);

    expect_string(__wrap_wfopen, path, "var/upgrade/blackwell_agent_v4.0.0_windows.wpk");
    expect_string(__wrap_wfopen, mode, "rb");
    will_return(__wrap_wfopen, 1);

    expect_string(__wrap_OS_SHA1_File, fname, "var/upgrade/blackwell_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_wpk_exist_diff_sha1(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:agent-upgrade");
    expect_string(__wrap__mtdebug1, formatted_msg, "(8161): Downloading WPK file from: 'https://packages.wazuh.com/4.x/wpk/windows/blackwell_agent_v4.0.0_windows.wpk'");

    expect_string(__wrap_wurl_request, url, "https://packages.wazuh.com/4.x/wpk/windows/blackwell_agent_v4.0.0_windows.wpk");
    expect_string(__wrap_wurl_request, dest, "var/upgrade/blackwell_agent_v4.0.0_windows.wpk");
...
void test_wm_agent_upgrade_validate_task_status_message_error_code(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:agent-upgrade");
