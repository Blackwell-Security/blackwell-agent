...
#include "../blackwell_modules/wm_office365.h"
#include "../blackwell_modules/wm_office365.c"
...
static int teardown_conf(void **state) {
    ...
    test_mode = 0;
    expect_string(__wrap__mtinfo, tag, "blackwell-modulesd:office365");
...
void test_wm_office365_main_fail_StartMQ(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "blackwell-modulesd:office365");
...
void test_wm_office365_main_enable(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "blackwell-modulesd:office365");
...
void test_wm_office365_get_access_token_with_auth_secret_response_200(void **state) {
    ...
    os_strdup("{\"access_token\":\"blackwell\"}", data->response->body);
    os_strdup("test", data->response->header);
    ...
    assert_string_equal(access_token, "blackwell");
    assert_null(error_msg);
...
void test_wm_office365_scan_failure_action_not_null(void **state) {
    ...
    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:office365");
    expect_string(__wrap__mtwarn, formatted_msg, "Sending Office365 internal message: '{\"integration\":\"office365\",\"office365\":{\"actor\":\"blackwell\",\"tenant_id\":\"tenant_id\",\"subscription_name\":\"subscription_name\",\"response\":\"Unknown error\"}}'");

    int result = -1;
    expect_value(__wrap_wm_sendmsg, usec, 1000000);
    expect_value(__wrap_wm_sendmsg, queue, queue_fd);
    expect_string(__wrap_wm_sendmsg, message, "{\"integration\":\"office365\",\"office365\":{\"actor\":\"blackwell\",\"tenant_id\":\"tenant_id\",\"subscription_name\":\"subscription_name\",\"response\":\"Unknown error\"}}");
...
void test_wm_office365_scan_failure_action_not_null_error_msg(void **state) {
    ...
    expect_string(__wrap__mtwarn, tag, "blackwell-modulesd:office365");
    expect_string(__wrap__mtwarn, formatted_msg, "Sending Office365 internal message: '{\"integration\":\"office365\",\"office365\":{\"actor\":\"blackwell\",\"tenant_id\":\"tenant_id\",\"subscription_name\":\"subscription_name\",\"response\":\"{\\\"response\\\":\\\"test\\\"}\"}}'");

    int result = -1;
    expect_value(__wrap_wm_sendmsg, usec, 1000000);
    expect_value(__wrap_wm_sendmsg, queue, queue_fd);
    expect_string(__wrap_wm_sendmsg, message, "{\"integration\":\"office365\",\"office365\":{\"actor\":\"blackwell\",\"tenant_id\":\"tenant_id\",\"subscription_name\":\"subscription_name\",\"response\":\"{\\\"response\\\":\\\"test\\\"}\"}}");
    expect_string(__wrap_wm_sendmsg, locmsg, "office365");
    expect_value(__wrap_wm_sendmsg, loc, LOCALFILE_MQ);
    will_return(__wrap_wm_sendmsg, result);
...
void test_wm_office365_execute_scan_all(void **state) {
    ...
    char expHeader[OS_SIZE_8192];
    snprintf(expHeader, OS_SIZE_8192 -1, "Authorization: Bearer blackwell");
    ...
    expect_string(__wrap__mtdebug2, tag, "blackwell-modulesd:office365");
...
void test_wm_office365_execute_scan_manage_subscription_error(void **state) {
    ...
    char expHeader[OS_SIZE_8192];
    snprintf(expHeader, OS_SIZE_8192 -1, "Authorization: Bearer %s", "blackwell");
...
void test_wm_office365_execute_scan_get_logs_from_blob_response_null(void **state) {
    ...
    os_strdup("{\"test\":\"blackwell\"}", manage_subscription_response->body);
    ...
    expect_string(__wrap_wurl_http_request, header, "Content-Type: application/json");
    expect_string(__wrap_wurl_http_request, header, "Authorization: Bearer blackwell");
    expect_any(__wrap_wurl_http_request, header);
    expect_any(__wrap_wurl_http_request, method);
    expect_any(__wrap_wurl_http_request, header);
    expect_any(__wrap_wurl_http_request, url);
