...
#include "../wrappers/blackwell/config/syscheck_config_wrappers.h"
...
#include "../wrappers/blackwell/shared/syscheck_op_wrappers.h"
#include "../wrappers/blackwell/syscheckd/fim_db_wrappers.h"
#include "../wrappers/blackwell/syscheckd/run_check_wrappers.h"
#include "../wrappers/blackwell/syscheckd/run_realtime_wrappers.h"
#include "../wrappers/blackwell/syscheckd/fim_diff_changes_wrappers.h"
#include "../wrappers/blackwell/syscheckd/registry.h"
#include "../wrappers/blackwell/os_crypto/md5_op_wrappers.h"
#include "../wrappers/blackwell/shared/file_op_wrappers.h"
...
static void test_fim_scan_db_full_double_scan(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "blackwell: FIM DB: {\"fim_db_table\":\"file_entry\",\"file_limit\":50000,\"file_count\":50000,\"alert_type\":\"full\"}");
...
static void test_fim_check_db_state_full_to_empty(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "blackwell: FIM DB: {\"fim_db_table\":\"file_entry\",\"file_limit\":50000,\"file_count\":0,\"alert_type\":\"normal\"}");
    will_return(__wrap_send_log_msg, 1);
...
static void test_fim_check_db_state_empty_to_90_percentage(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "blackwell: FIM DB: {\"fim_db_table\":\"file_entry\",\"file_limit\":50000,\"file_count\":46000,\"alert_type\":\"90_percentage\"}");
    will_return(__wrap_send_log_msg, 1);
...
static void test_fim_check_db_state_empty_to_80_percentage(void **state) {
    ...
    expect_string(__wrap_send_log_msg, msg, "blackwell: FIM DB: {\"fim_db_table\":\"file_entry\",\"file_limit\":50000,\"file_count\":41000,\"alert_type\":\"80_percentage\"}");
    will_return(__wrap_send_log_msg, 1);
...
static void test_fim_check_db_state_full_to_normal(void **state) {
    expect_string(__wrap__minfo, formatted_msg, "(6036): The file database status returns to normal.");
    expect_string(__wrap_send_log_msg, msg, "blackwell: FIM DB: {\"fim_db_table\":\"file_entry\",\"file_limit\":50000,\"file_count\":10000,\"alert_type\":\"normal\"}");
    will_return(__wrap_send_log_msg, 1);
