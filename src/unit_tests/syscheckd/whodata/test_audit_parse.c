...
#include "wrappers/blackwell/shared/audit_op_wrappers.h"
#include "wrappers/blackwell/shared/debug_op_wrappers.h"
#include "wrappers/blackwell/shared/file_op_wrappers.h"
#include "wrappers/blackwell/syscheckd/audit_rule_handling_wrappers.h"
...
void test_filterkey_audit_events_hc(void **state) {
    ...
    audit_key_type ret;
    char * event = "type=LOGIN msg=audit(1571145421.379:659): pid=16455 uid=0 old-auid=4294967295 auid=0 tty=(none) old-ses=4294967295 ses=57 key=\"blackwell_hc\"";
    char buff[OS_SIZE_128] = {0};

    snprintf(buff, OS_SIZE_128, FIM_AUDIT_MATCH_KEY, "blackwell_hc");
    expect_string(__wrap__mdebug2, formatted_msg, buff);
...
void test_filterkey_audit_events_fim(void **state) {
    ...
    audit_key_type ret;
    char * event = "type=LOGIN msg=audit(1571145421.379:659): pid=16455 uid=0 old-auid=4294967295 auid=0 tty=(none) old-ses=4294967295 ses=57 key=\"blackwell_fim\"";
    char audit_key_msg[OS_SIZE_128] = {0};

    snprintf(audit_key_msg, OS_SIZE_128, FIM_AUDIT_MATCH_KEY, "blackwell_fim");
...
void test_filterkey_audit_events_missing_whitespace(void **state) {
    ...
    audit_key_type ret;
    char * event = "type=LOGIN msg=audit(1571145421.379:659): pid=16455 uid=0 old-auid=4294967295 auid=0 tty=(none) old-ses=4294967295 ses=57key=\"blackwell_fim\"";
...
void test_filterkey_audit_events_key_at_the_beggining(void **state) {
    ...
    audit_key_type ret;
    char * event = "key=\"blackwell_fim\" type=LOGIN msg=audit(1571145421.379:659): pid=16455 uid=0 old-auid=4294967295 auid=0 tty=(none) old-ses=4294967295 ses=57";
...
void test_filterkey_audit_events_hex_coded_key_fim(void **state) {
    ...
    audit_key_type ret;
    // The decoded key of the event is "blackwell_fim\001key_2\001key_1"
...
void test_filterkey_audit_events_separator_in_key(void **state) {
    ...
    audit_key_type ret;
    // The decoded key of the event is "blackwell_f`5\001key_2\001key_1"
    ...
    snprintf(syscheck.audit_key[0], OS_SIZE_64, "blackwell_f`5");

    char audit_key_msg[OS_SIZE_128] = {0};
    snprintf(audit_key_msg, OS_SIZE_128, FIM_AUDIT_MATCH_KEY, "blackwell_f`5");
    expect_string(__wrap__mdebug2, formatted_msg, audit_key_msg);
...
void test_audit_parse(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571914029.306:3004254): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55c5f8170490 a2=0 a3=7ff365c5eca0 items=2 ppid=3211 pid=44082 auid=4294967295 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"test\" exe=\"74657374C3B1\" key=\"blackwell_fim\" \
...
void test_audit_parse3(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571914029.306:3004254): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55c5f8170490 a2=0 a3=7ff365c5eca0 items=3 ppid=3211 pid=44082 auid=4294967295 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"test\" exe=\"74657374C3B1\" key=\"blackwell_fim\" \
        type=CWD msg=audit(1571914029.306:3004254): cwd=\"/root/test\" \
...
void test_audit_parse4(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571923546.947:3004294): arch=c000003e syscall=316 success=yes exit=0 a0=ffffff9c a1=7ffe425fc770 a2=ffffff9c a3=7ffe425fc778 items=4 ppid=3212 pid=51452 auid=0 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"mv\" exe=66696C655FC3B1 key=\"blackwell_fim\" \
...
void test_audit_parse_empty_fields(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571914029.306:3004254): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55c5f8170490 a2=0 a3=7ff365c5eca0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"test\" key=\"blackwell_fim\" \
        type=PROCTITLE msg=audit(1571914029.306:3004254): proctitle=726D0074657374 \
    ";
...
void test_audit_parse_delete(void **state) {
    ...
    char * buffer = "type=CONFIG_CHANGE msg=audit(1571920603.069:3004276): auid=0 ses=5 op=\"remove_rule\" key=\"blackwell_fim\" list=4 res=1";
...
void test_audit_parse_mv(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571925844.299:3004308): arch=c000003e syscall=82 success=yes exit=0 a0=7ffdbb76377e a1=556c16f6c2e0 a2=0 a3=100 items=5 ppid=3210 pid=52277 auid=20 uid=30 gid=40 euid=50 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"mv\" exe=\"/usr/bin/mv\" key=\"blackwell_fim\" \
...
void test_audit_parse_rm(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571988027.797:3004340): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55578e6d8490 a2=200 a3=7f9cd931bca0 items=3 ppid=3211 pid=56650 auid=2 uid=30 gid=5 euid=2 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"rm\" exe=\"/usr/bin/rm\" key=\"blackwell_fim\" \
...
void test_audit_parse_chmod(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571992092.822:3004348): arch=c000003e syscall=268 success=yes exit=0 a0=ffffff9c a1=5648a8ab74c0 a2=1ff a3=fff items=1 ppid=3211 pid=58280 auid=4 uid=99 gid=78 euid=29 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"chmod\" exe=\"/usr/bin/chmod\" key=\"blackwell_fim\" \
...
void test_audit_parse_rm_hc(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571988027.797:3004340): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55578e6d8490 a2=200 a3=7f9cd931bca0 items=3 ppid=3211 pid=56650 auid=2 uid=30 gid=5 euid=2 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"rm\" exe=\"/usr/bin/rm\" key=\"blackwell_hc\" \
        type=CWD msg=audit(1571988027.797:3004340): cwd=\"/root/test\" \
        type=PATH msg=audit(1571988027.797:3004340): item=0 name=\"/root/test\" inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=1 name=(null) inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=2 name=(null) inode=24 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=DELETE cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
    ...
    snprintf(audit_key_msg, OS_SIZE_128, FIM_AUDIT_MATCH_KEY, "blackwell_hc");
    expect_string(__wrap__mdebug2, formatted_msg, audit_key_msg);
...
void test_audit_parse_add_hc(void **state) {
    ...
    char * buffer = " \
        type=SYSCALL msg=audit(1571988027.797:3004340): arch=c000003e syscall=257 success=yes exit=0 a0=ffffff9c a1=55578e6d8490 a2=200 a3=7f9cd931bca0 items=3 ppid=3211 pid=56650 auid=2 uid=30 gid=5 euid=2 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"touch\" exe=\"/usr/bin/touch\" key=\"blackwell_hc\" \
        type=CWD msg=audit(1571988027.797:3004340): cwd=\"/root/test\" \
        type=PATH msg=audit(1571988027.797:3004340): item=0 name=\"/root/test\" inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=1 name=(null) inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=2 name=(null) inode=24 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=DELETE cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
...
void test_audit_parse_unknown_hc(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=SYSCALL msg=audit(1571988027.797:3004340): arch=c000003e syscall=90 success=yes exit=0 a0=ffffff9c a1=55578e6d8490 a2=200 a3=7f9cd931bca0 items=3 ppid=3211 pid=56650 auid=2 uid=30 gid=5 euid=2 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts3 ses=5 comm=\"chmod\" exe=\"/usr/bin/chmod\" key=\"blackwell_hc\" \
        type=CWD msg=audit(1571988027.797:3004340): cwd=\"/root/test\" \
        type=PATH msg=audit(1571988027.797:3004340): item=0 name=\"/root/test\" inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=1 name=(null) inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1571988027.797:3004340): item=2 name=(null) inode=24 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=DELETE cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
...
void test_audit_parse_delete_folder(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=CONFIG_CHANGE msg=audit(1572878838.610:220): op=remove_rule dir=\"/root/test\" key=\"blackwell_fim\" list=4 res=1 \
...
void test_audit_parse_delete_folder_hex(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=CONFIG_CHANGE msg=audit(1572878838.610:220): op=remove_rule dir=2F726F6F742F746573742F74657374C3B1 key=\"blackwell_fim\" list=4 res=1 \
        type=SYSCALL msg=audit(1572878838.610:220): arch=c000003e syscall=263 success=yes exit=0 a0=ffffff9c a1=55c2b7d7f490 a2=200 a3=7f2b8055bca0 items=2 ppid=4340 pid=62845 auid=0 uid=0 gid=0 euid=0 suid=0 fsuid=0 egid=0 sgid=0 fsgid=0 tty=pts1 ses=7 comm=\"rm\" exe=\"/usr/bin/rm\" key=(null) \
        type=CWD msg=audit(1572878838.610:220): cwd=\"/root\" \
        type=PATH msg=audit(1572878838.610:220): item=0 name=\"/root\" inode=655362 dev=08:02 mode=040700 ouid=0 ogid=0 rdev=00:00 nametype=PARENT cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
        type=PATH msg=audit(1572878838.610:220): item=1 name=\"test\" inode=110 dev=08:02 mode=040755 ouid=0 ogid=0 rdev=00:00 nametype=DELETE cap_fp=0 cap_fi=0 cap_fe=0 cap_fver=0 \
...
void test_audit_parse_delete_folder_hex3_error(void **state) {
    ...
    char audit_key_msg[OS_SIZE_128] = {0};
    char * buffer = " \
        type=CONFIG_CHANGE msg=audit(1572878838.610:220): op=remove_rule dir=0 key=\"blackwell_fim\" list=4 res=1 \
