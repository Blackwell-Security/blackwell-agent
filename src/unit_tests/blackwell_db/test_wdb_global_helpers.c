...
#include "../blackwell_db/helpers/wdb_global_helpers.h"
...
#include "../wrappers/blackwell/shared/rbtree_op_wrappers.h"
...
void test_wdb_insert_agent_error_json(void **state)
{
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Error creating data JSON for Blackwell DB.");
...
void test_wdb_get_agent_info_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get the agent's 1 information.");
...
void test_wdb_get_agent_labels_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get the agent's 1 labels.");
...
void test_wdb_update_agent_status_code_error_socket(void **state)
{
    ...
    const char *json_str = strdup("{\"id\":1,\"status_code\":-1,\"version\":\"Blackwell v4.5.0\",\"sync_status\":\"synced\"}");
    const char *query_str = "global update-status-code {\"id\":1,\"status_code\":-1,\"version\":\"Blackwell v4.5.0\",\"sync_status\":\"synced\"}";
    const char *response = "err";
    ...
    expect_string(__wrap_cJSON_AddStringToObject, name, "version");
    expect_string(__wrap_cJSON_AddStringToObject, string, "Blackwell v4.5.0");
    expect_string(__wrap_cJSON_AddStringToObject, name, "sync_status");
    expect_string(__wrap_cJSON_AddStringToObject, string, "synced");
    ...
    // Handling result
    expect_string(__wrap__mdebug1, formatted_msg, "Global DB Error in the response from socket");
    expect_string(__wrap__mdebug2, formatted_msg, "Global DB SQL query: global update-status-code {\"id\":1,\"status_code\":-1,\"version\":\"Blackwell v4.5.0\",\"sync_status\":\"synced\"}");
...
void test_wdb_get_agent_name_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get the agent's 1 name.");
...
void test_wdb_get_agent_group_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get the agent's 1 group.");
...
void test_wdb_find_agent_error_json_output(void **state)
{
    ...
    // Handling result
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB for agent ID.");
...
void test_wdb_get_all_agents_rbtree_wdbc_query_error(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get agent's IDs.");
...
void test_wdb_find_group_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get the agent group id.");
...
void test_wdb_update_groups_error_json(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to update groups.");
...
void test_wdb_get_distinct_agent_groups_error_no_json_response(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Error querying Blackwell DB to get agent's groups.");
