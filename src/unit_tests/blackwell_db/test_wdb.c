...
int blackwell_db_config_setup() {
    wdb_init_conf();

    return OS_SUCCESS;
}

int  blackwell_db_config_teardown() {
    wdb_free_conf();
...
void test_wdb_get_internal_config() {
    ...
    cJSON* root = cJSON_GetObjectItem(ret, "blackwell_db");
...
int main() {
    const struct CMUnitTest tests[] = {
        ...
        // wdb_get_config
        cmocka_unit_test_setup_teardown(test_wdb_get_config, blackwell_db_config_setup, blackwell_db_config_teardown),
        // wdb_check_backup_enabled
        cmocka_unit_test_setup_teardown(test_wdb_check_backup_enabled_enabled, blackwell_db_config_setup, blackwell_db_config_teardown),
        cmocka_unit_test_setup_teardown(test_wdb_check_backup_enabled_disabled, blackwell_db_config_setup, blackwell_db_config_teardown),
