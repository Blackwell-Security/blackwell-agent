...
#include "../wrappers/blackwell/os_regex/os_regex_wrappers.h"
#include "../wrappers/blackwell/shared/labels_op_wrappers.h"
#include "../wrappers/blackwell/blackwell_db/wdb_global_helpers_wrappers.h"
...
void test_server_success_json(void **state)
{
    ...
    char *exec_msg = "{\"version\":1,\"origin\":{\"name\":\"node01\",\"module\":\"blackwell-analysisd\"},\"command\":\"restart-blackwell0\",\"parameters\":{\"extra_args\":[],\"alert\":[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]}}";
...
void test_all_agents_success_json_string(void **state)
{
    ...
    char *version_1 = "Blackwell v4.2.0";
    char *version_2 = "Blackwell v4.0.0";
    data->ar->location = ALL_AGENTS;

    char *exec_msg_1 = "(local_source) [] NNS 003 {\"version\":1,\"origin\":{\"name\":\"node01\",\"module\":\"blackwell-analysisd\"},\"command\":\"restart-blackwell0\",\"parameters\":{\"extra_args\":[],\"alert\":[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]}}";
    ...
    char *exec_msg = "(local_source) [] NNS 005 restart-blackwell0 - - 160987966.80794 554 (ubuntu) any->syscheck /home/vagrant/file/n44.txt -";
    ...
    os_strdup("_blackwell_version", labels_1[0].key);
    ...
    os_strdup("_blackwell_version", labels_2[0].key);
...
void test_all_agents_success_json_string_wdb(void **state)
{
    ...
    expect_string(__wrap_labels_get, key, "_blackwell_version");
...
void test_all_agents_success_fail_agt_info1(void **state)
{
    ...
    expect_string(__wrap__merror, formatted_msg, "Failed to get agent '3' information from Blackwell DB.");
    ...
    expect_string(__wrap__merror, formatted_msg, "Failed to get agent '5' information from Blackwell DB.");
...
void test_specific_agent_success_json(void **state)
{
    ...
    char *version = "Blackwell v4.2.0";
    data->ar->location = SPECIFIC_AGENT;

    char *exec_msg = "(local_source) [] NNS 002 {\"version\":1,\"origin\":{\"name\":\"node01\",\"module\":\"blackwell-analysisd\"},\"command\":\"restart-blackwell0\",\"parameters\":{\"extra_args\":[],\"alert\":[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]}}";
    const char *alert_info = "[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]";
    char *node = NULL;
    ...
    os_strdup("_blackwell_version", labels[0].key);
...
void test_specific_agent_success_string(void **state)
{
    ...
    char *version = "Blackwell v4.0.0";
    data->ar->location = SPECIFIC_AGENT;

    char *exec_msg = "(local_source) [] NNS 002 restart-blackwell0 - - 160987966.80794 554 (ubuntu) any->syscheck /home/vagrant/file/n44.txt -";
...
void test_specific_agent_success_fail_agt_info1(void **state)
{
    ...
    expect_string(__wrap__merror, formatted_msg, "Failed to get agent '2' information from Blackwell DB.");
...
void test_remote_agent_success_json(void **state)
{
    ...
    char *exec_msg = "(local_source) [] NRN 001 {\"version\":1,\"origin\":{\"name\":\"node01\",\"module\":\"blackwell-analysisd\"},\"command\":\"restart-blackwell0\",\"parameters\":{\"extra_args\":[],\"alert\":[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]}}";
    const char *alert_info = "[{\"timestamp\":\"2021-01-05T15:23:00.547+0000\",\"rule\":{\"level\":5,\"description\":\"File added to the system.\",\"id\":\"554\"}}]";
    char *node = NULL;
...
void test_remote_agent_success_string(void **state)
{
    ...
    char *exec_msg = "(local_source) [] NRN 001 restart-blackwell0 - - 160987966.80794 554 (ubuntu) any->syscheck /home/vagrant/file/n44.txt -";
...
void test_remote_agent_success_fail_agt_info1(void **state)
{
    ...
    expect_string(__wrap__merror, formatted_msg, "Failed to get agent '1' information from Blackwell DB.");
