...
#include "../wrappers/blackwell/shared/binaries_op_wrappers.h"
...
void test_compare_blackwell_versions_equal_patch(void **state)
{
    (void) state;
    char *v1 = "v4.0.0";
    char *v2 = "v4.0.0";

    int ret = compare_blackwell_versions(v1, v2, true);

    assert_int_equal(ret, 0);
}

void test_compare_blackwell_versions_equal_minor(void **state)
{
    (void) state;
    char *v1 = "3.13";
    char *v2 = "3.13";
...
void test_compare_blackwell_versions_equal_major(void **state)
{
    (void) state;
    char *v1 = "4";
    char *v2 = "v4";
...
void test_compare_blackwell_versions_greater_patch(void **state)
{
    (void) state;
    char *v1 = "4.0.1";
    char *v2 = "v4.0.0";
...
void test_compare_blackwell_versions_greater_patch_no_patch(void **state)
{
    (void) state;
    char *v1 = "4.0.1";
    char *v2 = "v4.0.0";

    int ret = compare_blackwell_versions(v1, v2, false);

    assert_int_equal(ret, 0);
}

void test_compare_blackwell_versions_greater_minor(void **state)
{
    (void) state;
    char *v1 = "2.15";
    char *v2 = "2";
...
void test_compare_blackwell_versions_greater_major(void **state)
{
    (void) state;
    char *v1 = "v5";
    char *v2 = "4.9";
...
void test_compare_blackwell_versions_lower_patch(void **state)
{
    (void) state;
    char *v1 = "v4.0.1";
    char *v2 = "v4.0.3";
...
void test_compare_blackwell_versions_lower_minor(void **state)
{
    (void) state;
    char *v1 = "2.15.1";
    char *v2 = "2.18";
...
void test_compare_blackwell_versions_lower_major(void **state)
{
    (void) state;
    char *v1 = "v5";
    char *v2 = "v6.1";
...
void test_compare_blackwell_versions_null(void **state)
{
    (void) state;
    char *v1 = NULL;
    char *v2 = NULL;
...
int main(void) {
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test(test_compare_blackwell_versions_equal_patch),
            cmocka_unit_test(test_compare_blackwell_versions_equal_minor),
            cmocka_unit_test(test_compare_blackwell_versions_equal_major),
            cmocka_unit_test(test_compare_blackwell_versions_greater_patch),
            cmocka_unit_test(test_compare_blackwell_versions_greater_patch_no_patch),
            cmocka_unit_test(test_compare_blackwell_versions_greater_minor),
            cmocka_unit_test(test_compare_blackwell_versions_greater_major),
            cmocka_unit_test(test_compare_blackwell_versions_lower_patch),
            cmocka_unit_test(test_compare_blackwell_versions_lower_minor),
            cmocka_unit_test(test_compare_blackwell_versions_lower_major),
            cmocka_unit_test(test_compare_blackwell_versions_null)
    };
