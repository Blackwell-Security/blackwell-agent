...
/**
 * Function with all the necessary functionality to process the uninstallation validation of the Blackwell agent package.
...
static const char AG_IN_UNMERGE[] = "blackwell: Could not unmerge shared file.";
