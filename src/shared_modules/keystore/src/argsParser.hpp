...
public:
    ...
    {
        std::cout << "\nUsage: blackwell-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./blackwell-keystore -f indexer -k username -v admin\n"
                  << "\n\t./blackwell-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./blackwell-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./blackwell-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./blackwell-keystore -f indexer -k password\n"
                  << std::endl;
    }
