...
TEST_F(DBSyncTest, GetDeletedRowsOnlyPKs)
{
    ...
    auto syncSqlStmt1 = SyncRowQuery::builder().table("processes")
                        .data(nlohmann::json::parse(R"({"pid":4,"name":"System","euser":"blackwell"})"))
                        .query();
    auto syncSqlStmt2 = SyncRowQuery::builder().table("processes")
                        .data(nlohmann::json::parse(R"({"pid":7,"name":"Guake","euser":"blackwell"})"))
                        .query();
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"blackwell"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"blackwell"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"euser":"blackwell","name":"System","pid":4})"))).Times(1);
...
TEST_F(DBSyncTest, GetDeletedRowsAllAttributes)
{
    ...
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"blackwell"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(INSERTED, nlohmann::json::parse(R"({"name":"Guake","pid":7,"euser":"blackwell"})"))).Times(1);
    EXPECT_CALL(wrapper, callbackMock(DELETED, nlohmann::json::parse(R"({"name":"System","pid":4,"euser":"blackwell"})"))).Times(1);
