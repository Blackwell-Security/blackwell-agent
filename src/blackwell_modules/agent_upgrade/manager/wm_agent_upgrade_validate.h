 ...
 * @param blackwell_version blackwell version of agent
 * @param platform platform of agent to validate
 ...
 * @retval WM_UPGRADE_GLOBAL_DB_FAILURE
 * */
int wm_agent_upgrade_validate_version(const char *blackwell_version, const char *platform, wm_upgrade_command command, void *task)  __attribute__((nonnull(4)));
