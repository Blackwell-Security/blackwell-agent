...
int wm_max_eps;             // Maximum events per second sent by OpenScap and CIS-CAT Blackwell Module
...
int wm_config() {
    ...
    wm_task_nice = getDefine_Int("blackwell_modules", "task_nice", -20, 19);
    wm_max_eps = getDefine_Int("blackwell_modules", "max_eps", 1, 1000);
    wm_kill_timeout = getDefine_Int("blackwell_modules", "kill_timeout", 0, 3600);
...
cJSON *getModulesInternalOptions(void) {
    ...
    cJSON_AddNumberToObject(internals,"blackwell_modules.task_nice",wm_task_nice);
    cJSON_AddNumberToObject(internals,"blackwell_modules.max_eps",wm_max_eps);
    cJSON_AddNumberToObject(internals,"blackwell_modules.kill_timeout",wm_kill_timeout);
    cJSON_AddNumberToObject(internals,"blackwell_modules.debug",wm_debug_level);
