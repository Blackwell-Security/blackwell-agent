...
extern int wm_max_eps;          // Maximum events per second sent by OpenScap Blackwell Module
...
/*
 * @brief Get ID group of Blackwell user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of blackwell modules
 *
