                            ...
                            agent_info_data *agent_data)
{
    ...
    for (line = strtok_r(msg_tmp, sdelim, &savedptr); line; line = strtok_r(NULL, sdelim, &savedptr)) {
        ...
        case '\"': // Regular label
            ...
            break;
        default:
            // uname - blackwell version / config sum
                ...
                *str_tmp = '\0';
                ...
                if (str_tmp = strstr(line, " / "), str_tmp) {
                    *str_tmp = '\0';
                    ...
                    // If for some reason the separator between Blackwell version and config sum is
                    // not found, we look for the Blackwell version in the second part of the line.
