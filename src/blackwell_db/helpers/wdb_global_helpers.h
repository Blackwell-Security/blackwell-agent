/*
 * Blackwell DB helper module for agents database
 ...
 * @param[in] sock The Blackwell DB socket connection. If NULL, a new connection will be created and closed locally.
 ...
 * This method creates and sends a command to BlackwellDB to receive the ID of every agent.
 ...
 * This method creates and sends a command to BlackwellDB to set as disconnected all the
