...
cJSON* wdb_get_internal_config() {
    cJSON* blackwell_db_config = cJSON_CreateObject();
    cJSON *root = cJSON_CreateObject();

    cJSON_AddNumberToObject(blackwell_db_config, "commit_time_max", wconfig.commit_time_max);
    cJSON_AddNumberToObject(blackwell_db_config, "commit_time_min", wconfig.commit_time_min);
    cJSON_AddNumberToObject(blackwell_db_config, "open_db_limit", wconfig.open_db_limit);
    cJSON_AddNumberToObject(blackwell_db_config, "worker_pool_size", wconfig.worker_pool_size);
    cJSON_AddNumberToObject(blackwell_db_config, "fragmentation_threshold", wconfig.fragmentation_threshold);
    cJSON_AddNumberToObject(blackwell_db_config, "fragmentation_delta", wconfig.fragmentation_delta);
    cJSON_AddNumberToObject(blackwell_db_config, "free_pages_percentage", wconfig.free_pages_percentage);
    cJSON_AddNumberToObject(blackwell_db_config, "max_fragmentation", wconfig.max_fragmentation);
    cJSON_AddNumberToObject(blackwell_db_config, "check_fragmentation_interval", wconfig.check_fragmentation_interval);

    cJSON_AddItemToObject(root, "blackwell_db", blackwell_db_config);
