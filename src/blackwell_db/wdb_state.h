...
typedef struct _blackwelldb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} blackwelldb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    blackwelldb_breakdown_t blackwelldb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total blackwelldb queries counter
 *
 */
void w_inc_blackwelldb();

/**
 * @brief Increment remove blackwelldb queries counter
 *
 */
void w_inc_blackwelldb_remove();

/**
 * @brief Increment remove blackwelldb time counter
 *
...
/**
 * @brief Create a JSON object with all the blackwell-db state information
 * @return JSON object
 */
