...
/* Blackwell-logtest's fields names for the requests and responses */
...
/**
 * @brief Initialize Blackwell Logtest. Initialize the listener and create threads
...
/**
 * @brief Main function of Blackwell Logtest module
 *
