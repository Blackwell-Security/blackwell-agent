...
#define HOME_ERROR    "(1108): Unable to find Blackwell install directory. Export it to BLACKWELL_HOME environment variable."
...
#define A_QUERY_ERROR           "(1286): Blackwell-db query error, check wdb logs."
#define INVALID_TYPE            "(1287): Incorrect/unknown type value %s."
#define WDBC_QUERY_EX_ERROR     "(1288): Blackwell-db query execution error."
...
#define AG_API_ERROR_CODE  "(4116): Unexpected status code in Blackwell agent package uninstallation request: %ld\n"
#define AG_REQUEST_FAIL    "(4117): Failed validation request to uninstall Blackwell agent package."
...
#define DB_COMPILED           "(5207): Blackwell not compiled with support for '%s'."
...
/* Blackwell Logtest error messsages */
...
#define LOGTEST_ERROR_INV_CONF                      "(7304): Invalid blackwell-logtest configuration"
...
#define BLACKWELL_HOMEDIR "Blackwell home directory: %s"
...
#define OS_NORMAL_BUFFER  "blackwell: Agent buffer: 'normal'."
#define OS_WARN_BUFFER  "blackwell: Agent buffer: '%d%%'."
#define OS_FULL_BUFFER  "blackwell: Agent buffer: 'full'."
#define OS_FLOOD_BUFFER "blackwell: Agent buffer: 'flooded'."
