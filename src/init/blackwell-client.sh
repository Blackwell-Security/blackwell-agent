...
DAEMONS="blackwell-modulesd blackwell-logcollector blackwell-syscheckd blackwell-agentd blackwell-execd"
...
check_folders()
{
    ...
    if [ ! -d $ALERTS_FOLDER ]
    then
        if rm -rf $ALERTS_FOLDER && mkdir -p $ALERTS_FOLDER && chown blackwell:blackwell $ALERTS_FOLDER && chmod 770 $ALERTS_FOLDER
        then
