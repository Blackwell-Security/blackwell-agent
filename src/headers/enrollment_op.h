 ...
 *
 * Blackwell agents need to register to a manager before being able to start sending messages
 ...
 * For details on enrollment process @see https://documentation.blackwell.com/3.12/user-manual/registering/
 */
