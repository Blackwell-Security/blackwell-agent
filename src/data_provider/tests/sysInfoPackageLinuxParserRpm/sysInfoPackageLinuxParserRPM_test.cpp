...
TEST(SysInfoPackageLinuxParserRPM_test, rpmFromBerkleyDB)
{
    ...
    auto expectedPackage1 =
        R"({"architecture":"amd64","description":"The Open Source Security Platform","format":"rpm","groups":"test","install_time":"5","name":"Blackwell","size":321,"vendor":"The Blackwell Team","version":"123:4.4-1","location":" ","priority":" ","source":" "})"_json;
    ...
    int itime { 5 };
    int size { 321 };
    std::string vendor { "The Blackwell Team" };
