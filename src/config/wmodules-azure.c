/*
 * Blackwell Module Configuration
...
static const char *AUTHENTICATION_OPTIONS_URL = "https://documentation.blackwell.com/current/azure/activity-services/prerequisites/credentials.html";
