...
#ifndef BLACKWELL_DB_CONFIG_H
#define BLACKWELL_DB_CONFIG_H
 ...
 */
int Read_BlackwellDB(const OS_XML *xml, XML_NODE chld_node);

/**
 * @brief This method will read the "backup" configuration block of Blackwell-DB.
 *
 * @param xml The configuration file to read.
 ...
 * @return int OS_SUCCESS if the configuration was read with no errors, OS_INVALID otherwise.
 */
int Read_BlackwellDB_Backup(const OS_XML *xml, xml_node * node, int const BACKUP_NODE);
